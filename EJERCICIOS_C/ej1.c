...
int main() {
    ...
    // int n_data4[0] = {};
    // int test_res[4] = {compareLists(ls[0], n_data, 3), compareLists(ls[1], n_data2, 2), 
    ...
    // int f_data4[0] = {};
    // int test_res[4] = {compareLists(ls[0], f_data, 1), compareLists(ls[1], f_data2, 2), 
    ...
    // int l_data4[0] = {};
    // int test_res[4] = {compareLists(ls[0], l_data, 1), compareLists(ls[1], l_data2, 2), 
